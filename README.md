...
- `public/data/site.json`: brand, navigation, hero copy, contribution pathways, format, city, CTA, footer, and UI text.
...
- `public/data/gallery.json`: previous Jam photos copied from the archived website/Luma-derived gallery assets.
- `public/data/feature-flags.json`: section and behavior toggles.
